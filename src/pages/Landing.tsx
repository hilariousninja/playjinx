      ...
      <main className="flex justify-center px-5 pt-8 pb-6">
        ...
        >
          ...
          {allDone ? (
            ...
            >
              <p className="text-[10px] text-muted-foreground/70 uppercase tracking-[0.2em] font-display mb-2.5 text-left border border-border rounded px-2 py-0.5 inline-block">Example prompt</p>
